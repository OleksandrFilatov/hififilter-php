            ...
            <div class="block-header block-header--has-breadcrumb block-header--has-title">
                <div class="container">
                    <div class="block-header__body">
                        ...
                        <h1 class="block-header__title">Egyszerű árajánlatkérés cikkszám alapján</h1>
                    </div>
                </div>
            </div>
            <div class="checkout block">
                <div class="container container--max--xl">
                    <form action="save-req.php" method="post">
                        <div class="col-8 m-auto">
                            <div class="card mb-lg-0">
                                <div class="card-body card-body--padding--2">
                                    <h3 class="card-title">Kérjen terméket</h3>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                          <label for="art_num">Cikkszám</label>
                                          <input required type="text" class="form-control" name="art_num" id="art_num" placeholder="Cikkszám" name="szallitasi_nev">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment" placeholder="Adja meg a szűrő méreteit, milyen gépjárműbe, eszközbe szeretné beszerelni." class="form-control" rows="4"></textarea>
                                    </div>
