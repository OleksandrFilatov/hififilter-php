        ...
        <div class="site__body">
            ...
            <div class="container mt-5 mb-5">
                <div class="row justify-content-space">
                    <h1 class="text-center col-lg-12">Találatok</h1>
                    <?php
                        if(isset($_GET['reference'])){
                            $_GET['reference'] = urlencode($_GET['reference']);
                            $api = new Api();
                            $api->connectAPI();
                            foreach ($api->getDataByReference($_GET['reference'])->articles as $key => $value) {
                                ...
                                if($arrayFilter->photo == ""){
                                    echo'<img src="https://portal.hifi-filter.com/img/no-img.png" style="height:200px">';
                                }else{
                                    echo'<img src="https://hifi-filter.com/img/filtre/'.urlencode($arrayFilter->photo).'" style="height:200px;padding:40px">';
                                }
                                    echo'<div class="suggestions__product-name mt-2">'.$value->equi.'<br><small>'.$value->designation.'</small></div>';
                                if (isset($_SESSION['frontenduser'])) {
                                    if($array[0]->unitPrice == ""){
                                        echo'<div class="suggestions__product-price text-center w-100 m-0 mb-2 ">Nem ismert</div>';
                                    }else{
                                        $realprice = $array[0]->unitPrice*$allrate;
                                        $price = intval($realprice*100)/100;
                                        echo'<div class="suggestions__product-price text-center w-100 m-0 mb-2 ">'.$price.$currencyunit.'</div>';
                                    }
                                }
                                echo'<a class="btn btn-danger" href="product.php?id='.$value->cell[2]->value.'">Megnézem</a></div>';        
                            }
                            $api->closeAPI();
                        }
                    ?>
