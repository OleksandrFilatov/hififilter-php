    ...
    <div class="site">
        ...
        <div class="site__body">
            <div class="block-finder block">
                ...
                <div class="block-finder__body container container--max--md">
                    <div class="block-finder__title">Szűrőt keres, de nem találja?</div>
                    <div class="block-finder__subtitle">Kérjen árajánlatot tőlünk! Több millió termékcikket tudunk beszerezni.</div>
                    <a href="product-request.php" style="padding: 10px 20px" class="block-finder__form-control block-finder__form-control--button" >lsmerem a szűrő cikkszámát</a>
                    <a href="product-request-unknown.php" style="padding: 10px 20px" class="block-finder__form-control block-finder__form-control--button" >Nincs meg a szűrő cikkszáma</a>
                </div>
            </div>
                        ...
                        <li class="block-features__item">
                            <div class="block-features__item-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48">
                                    ...
                                    <path d="M12,21.9c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8H8.8c-0.4,0-0.8,0.3-0.8,0.8v6.4c0,0.4,0.3,0.8,0.8,0.8	c0.4,0,0.8-0.3,0.8-0.8v-2.5h1.7c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8H9.5v-1.7L12,21.9L12,21.9z" />
                        ...
                        <li class="block-features__item">
                            <div class="block-features__item-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48">
                                    ...
                                    <path d="M40.3,33.5c-1.2,0-2.1,0.9-2.1,2.1c0,0.9,0.5,1.6,1.3,1.9v1.1c0,0.4,0.4,0.8,0.8,0.8s0.8-0.4,0.8-0.8v-1.1	c0.8-0.3,1.3-1.1,1.3-1.9C42.4,34.4,41.5,33.5,40.3,33.5z M40.3,35.1c0.3,0,0.5,0.2,0.5,0.5s-0.2,0.5-0.5,0.5s-0.5-0.2-0.5-0.5S40.1,35.1,40.3,35.1z" />
                                </svg>
                            </div>
                            <div class="block-features__item-info">
                        ...
                        <li class="block-features__item">
                            <div class="block-features__item-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48">
                                    ...
                                    <path d="M16.3,25.8c-0.3-0.3-0.8-0.3-1.1,0c-0.3,0.3-0.3,0.8,0,1.1l2.4,2.4l-3,3l-2.4-2.4c-0.3-0.3-0.8-0.3-1.1,0	c-0.3,0.3-0.3,0.8,0,1.1l5.9,5.9c0.2,0.2,0.4,0.2,0.5,0.2s0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1l-2.4-2.4l3-3l2.4,2.4c0.2,0.2,0.4,0.2,0.5,0.2s0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L16.3,25.8z" />
